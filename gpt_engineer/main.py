...
def main(
    ...
    model: str = "gpt-4",
    local_model: bool = typer.Option(False, help="Toggles local model utilizing OpenAI API"),
    openai_base: str = typer.Option("http://localhost:8080/v1", help="OpenAI Base URL"),
    openai_key: str = typer.Option("-", help="LocalAI Key"),
